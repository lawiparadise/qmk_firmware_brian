...
[_LOWER] = LAYOUT( \
  ...
  KC_F10,  LCTL(KC_LEFT), KC_LEFT,  KC_DOWN, KC_RIGHT,  LCTL(KC_RIGHT),                                   KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, LSFT(KC_SCLN), _______, \
  _______,   KC_F6,  KC_F7, KC_F8, KC_F9, KC_PGDN, _______,       _______, KC_0, LSFT(KC_LBRC), LSFT(KC_RBRC), LSFT(KC_9), LSFT(KC_0), _______, \
                   KC_ESC,  KC_DEL, _______, _______, _______,                    _______, _______, _______, KC_LBRC, KC_RBRC\
),
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_PSLS,  KC_7, KC_8,  KC_9,  KC_CALC,                         KC_PGUP, KC_PRVWD, KC_UP,   KC_NXTWD, KC_DLINE, KC_BSPC, \
  _______, KC_EQL, KC_4, KC_5, KC_6,  KC_PAST,                         KC_PGDN, KC_LEFT,  KC_DOWN, KC_RGHT,  KC_DEL,   KC_BSPC, \
